...
<head>
    ...
    <link rel="stylesheet" href="<?php echo url('assets/login/style.css') ?>" />
...
<body>
    <div class="container">
        <div class="forms-container">
            <div class="signin-signup">
                ...
                <form action="<?php echo url('atur') ?>" method="get" class="sign-in-form">
                    <a href="<?php echo url('atur'); ?>" style='padding-top: 70px'>
                        <img width="200px" src="<?= url('/') ?>/assets/images/logo/logo.png"></a>
                    <h2 class="title">
                        Menu Barcode System
                    </h2>
                ...
                <form action="#" class="sign-up-form"><a href="<?php echo url('auth/login'); ?>"><img width="200px" src="https://wellthefood.com/wp-content/uploads/2020/08/prs.png"></a>
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                ...
                <img src="<?php echo url('assets/login/img/log.svg') ?>" class="image" alt="" />
            </div>
            <div class="panel right-panel">
                ...
                <img src="<?php echo url('assets/login/img/register.svg') ?>" class="image" alt="" />
            </div>
        </div>
    </div>
    ...
    <script src="<?php echo url('assets/login/app.js') ?>"></script>
